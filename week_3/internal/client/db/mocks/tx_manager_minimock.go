...
//go:generate minimock -i github.com/Georgy27/go-grpc/week_3/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/Georgy27/go-grpc/week_3/internal/client/db"
