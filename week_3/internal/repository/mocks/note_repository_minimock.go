...
//go:generate minimock -i github.com/Georgy27/go-grpc/week_3/internal/repository.NoteRepository -o note_repository_minimock.go -n NoteRepositoryMock -p mocks
